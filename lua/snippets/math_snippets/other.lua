...
return function(is_math, not_math)
    ...
    s({ trig = "qu", condition = is_math, wordTrig = false, snippetType = "autosnippet" }, { t("/") }),
    -- s({ trig = "ic", condition = is_math, wordTrig = true, snippetType = "autosnippet" }, { t("\\boxplus") }),
    s({ trig = "es", condition = is_math, wordTrig = true, snippetType = "autosnippet" }, { t("\\varnothing") }),
    ...
    s({ trig = "inte", priority = 2000, condition = is_math, wordTrig=true, snippetType = "autosnippet" }, { t("\\int") }),
    s({ trig = "face", priority = 2000, condition = is_math, wordTrig=true, snippetType = "autosnippet" }, { t("\\triangleleft ") }),
    s({ trig = "face", condition = is_math, wordTrig=false, snippetType = "autosnippet" }, { t(" \\triangleleft ") }),
    s({ trig = "into", priority = 2000, condition = is_math, wordTrig=true, snippetType = "autosnippet" }, { t("\\hookrightarrow ") }),
    s({ trig = "into", condition = is_math, wordTrig=false, snippetType = "autosnippet" }, { t(" \\hookrightarrow ") }),
    s({ trig = "onto", priority = 2000, condition = is_math, wordTrig=true, snippetType = "autosnippet" }, { t("\\twoheadrightarrow ") }),
    s({ trig = "onto", condition = is_math, wordTrig=false, snippetType = "autosnippet" }, { t(" \\hookrightarrow ") }),
    ...
    s({ trig = "lep", priority=2000, condition = is_math, wordTrig = true, snippetType = "autosnippet" }, { t("\\preceq ") }),
    s({ trig = "lep", condition = is_math, wordTrig = false, snippetType = "autosnippet" }, { t(" \\preceq ") }),
    s({ trig = "gep", priority=2000, condition = is_math, wordTrig = true, snippetType = "autosnippet" }, { t("\\succeq ") }),
    s({ trig = "gep", condition = is_math, wordTrig = false, snippetType = "autosnippet" }, { t(" \\succeq ") }),
